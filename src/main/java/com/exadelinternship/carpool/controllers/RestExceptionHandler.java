...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        logger.info( servletWebRequest.getHttpMethod().toString()+ " to "+ servletWebRequest.getRequest().getServletPath());
    ...
    protected ResponseEntity<Object> handleDataIntegrityViolation(DataIntegrityViolationException ex,
        ...
        if (ex.getCause() instanceof ConstraintViolationException) {
            error=new ApiError(HttpStatus.CONFLICT, "Database error", ex.getCause());
            logger.error(error);
            return buildResponseEntity(error);
        }
        error=new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, ex);
        logger.error(error);
        return buildResponseEntity(error);
    }
